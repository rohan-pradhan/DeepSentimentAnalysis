...
pos_review_sent = [1]*len(pos_reviews_raw)
neg_review_sent = [0]*len(neg_reviews_raw)

x_test = pos_reviews_raw + neg_reviews_raw
y_test = pos_review_sent + neg_review_sent
...
x_train = [format_sentence(i) for i in df.text.astype(str).values.tolist()]
# # print (x_test)
